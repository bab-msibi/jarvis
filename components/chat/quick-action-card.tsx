...
export function QuickActionCard({ icon: Icon, title, description, onClick }: QuickActionCardProps) {
  return (
    <button
      className="flex w-full items-center gap-3 rounded-xl border border-cyan-900/35 bg-sky-950/35 px-3 py-2.5 text-left transition hover:border-cyan-500/45 hover:bg-cyan-500/10"
      onClick={onClick}
      type="button"
    >
