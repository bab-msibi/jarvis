...
export function CircularOverviewChart({ total, active, inactive, failed, drafts }: CircularOverviewChartProps) {
  const slices: Slice[] = [
    { label: "Active", value: active, color: "#22c55e" },
    { label: "Inactive", value: inactive, color: "#60a5fa" },
    { label: "Failed", value: failed, color: "#ef4444" },
    { label: "Drafts", value: drafts, color: "#a855f7" }
  ];
