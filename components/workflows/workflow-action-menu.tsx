...
export type WorkflowMenuAction = "edit" | "run" | "trigger" | "duplicate" | "delete";

type WorkflowActionMenuProps = {
  onAction: (action: WorkflowMenuAction) => void;
};

const menuItems: Array<{ key: WorkflowMenuAction; label: string; danger?: boolean }> = [
  { key: "edit", label: "Edit Workflow" },
  { key: "run", label: "Run Workflow" },
  { key: "trigger", label: "Configure Trigger" },
  { key: "duplicate", label: "Duplicate" },
  { key: "delete", label: "Delete Workflow", danger: true }
];

export function WorkflowActionMenu({ onAction }: WorkflowActionMenuProps) {
