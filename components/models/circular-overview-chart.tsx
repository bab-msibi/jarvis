...
export function CircularOverviewChart({ total, active, idle, error, local }: CircularOverviewChartProps) {
  const slices: Slice[] = [
    { label: "Active", value: active, color: "#22c55e" },
    { label: "Idle", value: idle, color: "#60a5fa" },
    { label: "Error", value: error, color: "#ef4444" },
    { label: "Local", value: local, color: "#a78bfa" }
  ];
